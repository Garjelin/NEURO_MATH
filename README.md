...
**Задание 1** (табл. 7.7, вар. 5): три образа **2×3** и значения **Y** из полного PDF практики 7; **MLPRegressor** и схема leave-one-out.
...
**Задание 3** (табл. 7.9, вар. 5): все допустимые тройки **(A, P, N)** для классов A и B, суммарный **triplet loss** (квадраты расстояний + margin); рис. 7.42 в PDF нет — четыре обучаемых вектора **A1, A2, B1, B2**.
